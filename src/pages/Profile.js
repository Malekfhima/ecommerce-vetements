...
const Profile = () => {
  ...
  return (
    <div className="container" style={{ maxWidth: '700px', paddingTop: '2rem' }}>
      ...
      <div style={{ background: 'white', padding: '2rem', borderRadius: 'var(--radius-lg)', marginTop: '2rem' }}>
        <form onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            ...
            />
            <small style={{ color: 'var(--gray-600)' }}>L'email ne peut pas être modifié</small>
          </div>
