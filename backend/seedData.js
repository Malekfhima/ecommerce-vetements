...
const products = [
  {
    ...
    stock: 50,
    images: ["https://placehold.co/600x800?text=T-shirt+Homme"],
    marque: "BasicWear",
    enVedette: true,
    note: 4.5,
    nombreAvis: 23,
  },
  {
    ...
    couleurs: ["Bleu", "Noir"],
    stock: 30,
    images: ["https://placehold.co/600x800?text=Jean+Homme"],
    marque: "DenimCo",
    enVedette: true,
    note: 4.8,
    nombreAvis: 45,
  },
  {
    ...
    stock: 25,
    images: ["https://placehold.co/600x800?text=Robe+Femme"],
    marque: "SummerStyle",
    enVedette: true,
    note: 4.7,
    nombreAvis: 38,
  },
  {
    ...
    stock: 20,
    images: ["https://placehold.co/600x800?text=Veste+Jean"],
    marque: "DenimCo",
    enVedette: true,
    note: 4.6,
    nombreAvis: 31,
  },
  {
    ...
    stock: 40,
    images: ["https://placehold.co/600x800?text=Pantalon+Enfant"],
    marque: "KidsWear",
    enVedette: false,
    note: 4.4,
    nombreAvis: 19,
  },
  {
    ...
    stock: 35,
    images: ["https://placehold.co/600x800?text=Chemise+Homme"],
    marque: "FormalWear",
    enVedette: false,
    note: 4.3,
    nombreAvis: 27,
  },
  {
    ...
    stock: 28,
    images: ["https://placehold.co/600x800?text=Jupe+Femme"],
    marque: "ChicStyle",
    enVedette: true,
    note: 4.5,
    nombreAvis: 22,
  },
  {
    ...
    couleurs: ["Blanc", "Noir", "Gris"],
    stock: 45,
    images: ["https://placehold.co/600x800?text=Baskets+Homme"],
    marque: "SportPro",
    enVedette: true,
    note: 4.9,
    nombreAvis: 67,
  },
  {
    ...
    stock: 22,
    images: ["https://placehold.co/600x800?text=Sac+Femme"],
    marque: "LuxeBags",
    enVedette: false,
    note: 4.6,
    nombreAvis: 34,
  },
  {
    ...
    stock: 60,
    images: ["https://placehold.co/600x800?text=Sweat+Capuche"],
    marque: "ComfortWear",
    enVedette: true,
    note: 4.7,
    nombreAvis: 52,
